// AIClass_template/exercise/top-bottom_layout/core/Frame.js
;(function () {
  ...
  function applyLayoutVars(sheet, layout) {
    ...
    setCssVar(sheet, '--lf-figure-height', layout.figureHeight)
    setCssVar(sheet, '--lf-figure-padding', layout.figurePadding)
    setCssVar(sheet, '--lf-figure-svg-width', layout.figureSvgWidth)
    setCssVar(sheet, '--lf-scroll-padding', layout.scrollPadding)
    setCssVar(sheet, '--lf-section-gap', layout.sectionGap)
  }
  ...
  AIClassFrame.prototype.mount = function () {
    ...
    sheet.id = id
    sheet.className = 'lf-sheet lf-sheet-top-bottom'
