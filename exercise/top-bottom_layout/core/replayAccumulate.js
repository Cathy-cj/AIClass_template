// AIClass_template/exercise/top-bottom_layout/core/replayAccumulate.js
;(function () {
  ...
  function replayAccumulate(steps, targetId) {
    ...
    if (targetIndex < 0) {
      throw new Error('[AIClassTemplate] step not found: ' + targetId)
    }

    var blocks = []
    var figure = null
    var targetStep = normalized[targetIndex]
    var currentStepId = targetStep.id
    var currentStart = 0
    var currentEnd = 0
